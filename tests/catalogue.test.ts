...
describe("endpoint catalogue guards", () => {
  ...
  it("contains only GET entries with unique ids", () => {
    ...
    expect(paths).toEqual(new Set([
      ...
      "/cards/mint_history",
      "/cards/pack_data_wax",
      "/cards/pack_jackpot_overview",
      "/cards/skins",
      "/cards/ca_gold_rewards",
      "/cards/stats",
      "/cards/trx_lookup",
      "/ranked_draws/status",
      "/ranked_draws/prize_overview",
      "/ranked_draws/complete",
      "/ranked_draws/entries_completed",
      "/ranked_draws/available_prizes",
      "/ranked_draws/recent_prizes",
      "/frontier_draws/status",
      "/frontier_draws/prize_overview",
      "/frontier_draws/complete",
      "/frontier_draws/entries_completed",
      "/frontier_draws/available_prizes",
      "/frontier_draws/recent_prizes",
